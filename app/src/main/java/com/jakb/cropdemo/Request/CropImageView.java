package com.jakb.cropdemo.Request;
...
import com.jakb.cropdemo.R;
import com.jakb.cropdemo.animation.SimpleValueAnimator;
import com.jakb.cropdemo.animation.SimpleValueAnimatorListener;
import com.jakb.cropdemo.animation.ValueAnimatorV14;
import com.jakb.cropdemo.animation.ValueAnimatorV8;
import com.jakb.cropdemo.callback.Callback;
import com.jakb.cropdemo.callback.CropCallback;
import com.jakb.cropdemo.callback.LoadCallback;
import com.jakb.cropdemo.callback.SaveCallback;
import com.jakb.cropdemo.util.Logger;
import com.jakb.cropdemo.util.Utils;
      ...
      public void run() {
        ...
        try {
          ...
          if (croppedImage == null) {
            postErrorOnMainThread((Callback) cropCallback, e);
          } else {
